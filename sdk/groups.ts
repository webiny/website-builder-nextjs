...
export const componentGroups: ComponentGroup[] = [
    ...
    },
    {
        name: "sections",
        label: "Sections",
        description: "Full width page sections from the starter kit",
        icon: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M3 4h18v5H3V4zm0 7h18v4H3v-4zm0 6h18v3H3v-3z"/></svg>'
    },
    {
        name: "custom",
        label: "Custom",
